...
# Importing CSV library and os library
import csv
import os
...
if transaction_count > 0:
    ...
    # Print rounded average transaction amount
    print(f"\nAVERAGE TRANSACTION AMOUNT: {(round(total_transaction_amount / transaction_count, 2))}")
